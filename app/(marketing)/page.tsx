      ...
      <section className="container mx-auto px-4 py-24 md:py-32 max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Real-time AI transcription for conferences, workshops, and in-person events. Built by event organizers who
            understand accessibility matters.
          </p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="p-6 rounded-lg border border-white/10 bg-black/40 backdrop-blur-sm hover:bg-white/5 transition-all">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  ...
                  should miss out on important content.
                </p>
              </div>
              ...
              <div className="p-6 rounded-lg border border-white/10 bg-black/40 backdrop-blur-sm hover:bg-white/5 transition-all">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  ...
                  at their own pace while listening.
                </p>
              </div>
