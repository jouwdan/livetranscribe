...
export function WelcomeDialog({ eventId, eventSlug }: WelcomeDialogProps) {
  ...
  useEffect(() => {
    console.log("[v0] WelcomeDialog mounted with:", { eventId, eventSlug, eventIdType: typeof eventId })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("[v0] Submitting survey response:", {
      email,
      eventId,
      eventIdValue: eventId,
      eventIdType: typeof eventId,
      eventIdIsUndefined: eventId === undefined,
      eventIdIsNull: eventId === null,
    })
    ...
    try {
      ...
      console.log("[v0] Request body stringified:", JSON.stringify(requestBody))
